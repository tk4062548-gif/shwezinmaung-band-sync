...
- [x] Band schedule app v1 (events, roles, calendar/list, search, i18n, realtime, PWA)
- [x] Fix email verification redirect: confirmation link now lands on an in-app "Email verified" page, then sign in
